...
public class UserController
{
    ...
    public String login(@Valid @ModelAttribute("loginRequest") AuthenticationRequest request, Model model, HttpServletResponse response) {
        ...
        try {
            ...
            log.info("Quyền của người dùng: {}", SecurityContextHolder.getContext().getAuthentication().getAuthorities());
