...
public class EmailService {
    ...
    public void sendVerificationEmail(String recipientEmail, String link) throws MessagingException {
        ...
        helper.setText("<p>Please click the link below to verify your account:</p>"
                + "<p><a href=\"" + link + "\">Verify your account</a></p>", true);

        javaMailSender.send(message);
    }

    public void sendResetPassword(String recipientEmail, String link) throws MessagingException {
        MimeMessage message = javaMailSender.createMimeMessage();
        MimeMessageHelper helper = new MimeMessageHelper(message);
        ...
        helper.setTo(recipientEmail);
        helper.setSubject("Account Verification");
        helper.setText("<p>Please click the link below to reset your password account:</p>"
                + "<p><a href=\"" + link + "\">Reset your password account</a></p>", true);
