...
public class BillService {
    ...
    public List<Bill> findBillsByUserId(int userId) {
        // Assuming you have a method in your repository that fetches bills by user ID
        return billRepository.findByUserId(userId);
    }

    public List<Bill_detail> findBillsDetailByBillId(int billId) {
        // This assumes you have a BillDetailRepository and it's correctly wired
        return billDetailRepository.findByBillId(billId);  // Query to fetch BillDetails by Bill ID
    }
