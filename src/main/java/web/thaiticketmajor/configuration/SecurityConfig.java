...
public class SecurityConfig {
    ...
    private final String[] PUBLIC_ENDPOINTS = { "/index","/css/user/**","/user/login","/user/verify","/user/reset-password", "/user/forgot-password", "/concert/payment", "/user/signup", "/admin/login", "user/them", "/category/them", "/images/**","/image/**", "/css/admin/assets/**"};
